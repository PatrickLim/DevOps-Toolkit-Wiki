While the RCM Classic application (**Insight.exe**) is approaching EOL next year, it is currently the **best way to safely configure master tables, features, and services; no T-SQL or database knowledge needed.**
